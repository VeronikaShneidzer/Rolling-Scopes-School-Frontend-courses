...
export default class Monster {
	...
	drawDefend() {
		...
		let imgPath = "./../../screens/monster/images/" + this.monster + "/anim/" + dataPath["name"];
	...
	drawSpell() {
		...
		let imgPathAnim = "./../../screens/monster/images/" + this.monster + "/anim/" + dataPathAnim["name"];
		let dataPathFx = this.data[this.location]["monsters"][this.monster]["attack"][this.currSpell]["fx"];
		let imgPathFx = "./../../screens/monster/images/" + this.monster + "/fx/" + dataPathFx["name"];
