...
function getRectangleString(width, height) {
    ...
    return firstLine.concat(otherLines.repeat(height - 2), lastLine);
}
...
function encodeToRot13(str) {
    ...
    for(let i = 0; i < str.length; i++) {
        (alphabet.includes(str[i])) ? newString += rot13[alphabet.indexOf(str[i])] : newString += str[i];
    }
...
function getCardId(value) {
    let cards = 'A♣2♣3♣4♣5♣6♣7♣8♣9♣0♣J♣Q♣K♣A♦2♦3♦4♦5♦6♦7♦8♦9♦0♦J♦Q♦K♦A♥2♥3♥4♥5♥6♥7♥8♥9♥0♥J♥Q♥K♥A♠2♠3♠4♠5♠6♠7♠8♠9♠0♠J♠Q♠K♠';
    return Math.ceil(cards.indexOf((value.length === 3) ? value.slice(1) : value) / 2);
}
